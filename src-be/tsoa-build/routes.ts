...
import { expressAuthentication } from './../app/security';
...
export function RegisterRoutes(app: express.Router) {
	...
	// ###########################################################################################################
	app.get('/api/radar-data-items/:radarId', function (request: any, response: any, next: any) {
		const args = {
	...
	// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
	app.get('/api/radars', function (request: any, response: any, next: any) {
		const args = {};
		...
		const promise = controller.getAllLatestRadars.apply(controller, validatedArgs as any);
		promiseHandler(controller, promise, response, next);
	});
	// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
	app.get('/api/radars/:radarId', function (request: any, response: any, next: any) {
		const args = {
			radarId: { in: 'path', name: 'radarId', required: true, dataType: 'string' },
		};
	...
	// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
	app.post('/api/radars/:radarId', authenticateMiddleware([{ 'admin-access': [] }]), function (request: any, response: any, next: any) {
		const args = {
			radarId: { in: 'path', name: 'radarId', required: true, dataType: 'string' },
		...
		const promise = controller.updateRadar.apply(controller, validatedArgs as any);
		promiseHandler(controller, promise, response, next);
	});
	// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
	app.delete('/api/radars/:radarId', authenticateMiddleware([{ 'admin-access': [] }]), function (request: any, response: any, next: any) {
		const args = {
			radarId: { in: 'path', name: 'radarId', required: true, dataType: 'string' },
		};
		...
		const promise = controller.deleteRadar.apply(controller, validatedArgs as any);
		promiseHandler(controller, promise, response, next);
	});
	// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
	app.get('/api/user', function (request: any, response: any, next: any) {
		const args = {
		...
		return (request: any, _response: any, next: any) => {
			...
			for (const secMethod of security) {
				if (Object.keys(secMethod).length > 1) {
					...
					for (const name in secMethod) {
						expressAuthentication(request, name, secMethod[name]).then(succeed).catch(fail);
					}
				}
			}
		};
